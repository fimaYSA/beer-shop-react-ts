...
export function FormAnyQuestions() {
  return (
    <form
      style={{
        backgroundImage: `url(${import.meta.env.BASE_URL}images/background/hop_parallax.jpg)`,
      }}
      className={'h-91 w-72.5 rounded-[5px] bg-cover bg-center bg-no-repeat lg:w-63.75'}
    >
